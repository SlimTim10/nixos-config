...
$ sudo mount -t ntfs -o umask=000 /dev/sda1 /mnt/external-hdd # for NTFS-formatted drive, full R/W permission
...
sudo nix store delete --ignore-liveness /nix/store/17rr89knzpnk3hg3cb8fw63qw5lglqxk-tty-solitaire-1.3.1
